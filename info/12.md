...
모듈|설명|문법|기본값|사용장소|Override옵션|상태
---|---|---|---|---|---|---
mod_auth_basic|인증과 권한부여를 저수준 모듈에 넘겨줄지 결정한다|AuthBasicAuthoritative On/Off|AuthBasicAuthoritative On|directory, .htaccess|AuthConfig|Base
mod_authn_file|
mod_authz_groupfile|
mod_authz_host|
